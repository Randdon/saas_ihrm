...
@Configuration
@EnableJpaRepositories(value = "com.zhouyuan.redis_demo.dao",
...
public class WriteDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean writeEntityManagerFactoryBean(
        ...
        return builder.dataSource(routingDataSource).properties(jpaProperties.getProperties())
                .packages("com.zhouyuan.redis_demo.entity") // 设置实体类所在位置
